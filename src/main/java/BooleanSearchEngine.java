...
String pdfsDir;
    public BooleanSearchEngine(File pdfsDir) throws IOException {
        ...
        Map<String, Integer> freqs = new HashMap<>();//количество слов на одной странице
...
// second step - counting words
        ...
        while (iterator.hasNext()) {
            ...
            for (var word : words) { // перебираем слова
                ...
                //             searchReadyUnsorted.put(new PageEntry("SoftSkills", key, freqs.get(word)), word);
            }
            freqs.forEach((k, v) -> {
                searchReadyUnsorted.put(new PageEntry("pdfs/SoftSkills.pdf", key, v), k);
            });
            freqs.clear();
        }
    }
